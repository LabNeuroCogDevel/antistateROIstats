...
# 20210626WF - copied from /Volumes/Governator/ANTISTATELONG/MotionOutliers/createCensor.bash 
#
#  derive trans and rots enrom > .9
#  from ${funcdir}/mcplots_withRMS_nohdr.par[1..6]
#  see 1d_tool.py call
